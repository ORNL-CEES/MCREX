...
TEST(LinearSolverFactory, Basic)
{
    ...
    Teuchos::RCP<OP> solver =
        mcrex::LinearSolverFactory::buildSolver("richardson",A,pl);
    ...
    // Test Monte Carlo
    solver = Teuchos::null;
    solver = mcrex::LinearSolverFactory::buildSolver("monte_carlo",A,pl);
    ...
    // Test MCSA
    solver = Teuchos::null;
    solver = mcrex::LinearSolverFactory::buildSolver("mcsa",A,pl);
    ...
    solver = mcrex::LinearSolverFactory::buildSolver(
    ...
    // Test Belos
    solver = Teuchos::null;
    solver = mcrex::LinearSolverFactory::buildSolver("belos",A,pl);
    ...
    // Test Chebyshev
    solver = Teuchos::null;
    solver = mcrex::LinearSolverFactory::buildSolver("chebyshev",A,pl);

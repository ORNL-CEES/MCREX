...
#ifndef MCREX_ForwardMcKernel_i_hh
#define MCREX_ForwardMcKernel_i_hh
 ...
 */
//---------------------------------------------------------------------------//
void ForwardMcKernel::operator()(device_type dev) const
{
    LO     new_ind;
    GO     state;
    ...
    int myrank = dev.team_rank();
    int teamsize = dev.team_size();
...
#endif // MCREX_ForwardMcKernel_i_hh

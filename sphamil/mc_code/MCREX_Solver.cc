 ...
 */
//---------------------------------------------------------------------------//
MCREX_Solver::MCREX_Solver(Teuchos::RCP<const MATRIX> A,
 ...
 */
//---------------------------------------------------------------------------//
void MCREX_Solver::apply(const MV &x, MV &y, Teuchos::ETransp mode,
...
//---------------------------------------------------------------------------//
void MCREX_Solver::setParameters( Teuchos::RCP<Teuchos::ParameterList> pl )
{
    if( pl->isType<int>("max_iterations") )
    {

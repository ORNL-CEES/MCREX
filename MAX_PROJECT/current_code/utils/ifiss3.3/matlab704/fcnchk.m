...
%   $Revision: 1.29.4.12 $  $Date: 2008/09/13 06:56:42 $
...
if ~isempty(cellInfo)   % if fun is an MCOS object
...
f = '';
message = 'FUN must be a function, a valid string expression, or an inline function object.';

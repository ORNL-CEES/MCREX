%ELL_POISSONCONTROL is the driver for solving test problems
...
ell_type = default('[0,1] or [-1,1] ''L'' (enter 1/2) (default is [-1,1])',2);
...
if ell_type==1
    x = (x+1)/2; y = (y+1)/2; xy = (xy+1)/2;
elseif ell_type==2
else, error('illegal parameter choice ''ell_type'', try again.'), end

%SQUARE_POISSONCONTROL is the driver for solving test problems
...
%   square_type - selects the square [0,1]^2 or [-1,1]^2
...
else, error('illegal parameter choice ''square_type'', try again.'), end

function bookflowplot(qmethod,sol,By,Bx,A,xy,xyp,x,y,bound)
%bookflowplot generates plot for ESW2 book cover
%   flowplotz(qmethod,sol,By,Bx,A,xy,xyp,x,y,bound);
%   input

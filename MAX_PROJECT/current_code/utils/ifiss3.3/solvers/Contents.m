...
%   mg_ns_cd            - GMG for CD problem  (Navier-Stokes)
%   mg_ns_cd_setup      - GMG convection-diffusion problem (Navier-Stokes)
%   mg_ns_diff          - GMG for diffusion problem (Navier-Stokes)
%   mg_ns_diff_lstsq    - GMG for diffusion (Navier-Stokes, least-squares)
%   mg_ns_iter          - performs one MG iteration (Navier-Stokes)
%   mg_ns_prolong_step  - GMG prolongation for step domain (Navier-Stokes)
%   mg_ns_q1cd          - CD matrix generator for GMG (Navier-Stokes)
%   mg_ns_q1cd_supg     - SUPG matrix generator for GMG (Navier-Stokes)

function [x,y,xy,bound,mv,mbound] = ell_domain_x(nc,stretch)
%ELL_DOMAIN_X  pde_control | alternative L-shape domain Q2 grid generator 
%   [x,y,xy,bound,mv,mbound] = ell_domain_x(nc,stretch);
%    input
%         nc         grid parameter (3 for 8x8 grid)
%         stretch    stretch factor for the grid
%    output
...
% 
% grid defining data is directly output (cf. ell_domain)

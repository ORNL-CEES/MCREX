...
%   IFISS function: DJS; 7 June 2010; 5 January 2011; 26 April 2012; 24 June 2012
...
%
if tout==1,fprintf('\n   step  timestep       time        divresidual '), end
%%% first time step
n=1;                                              % time step index 
...
% local truncation error estimate   
   ...
   if tout==1,
   fprintf('\n  %4i   %9.3e   %11.3e    %9.3e   ', n, dt, t+dt,norm(gnst)); end
%%%%%% time step rejection  
  if d < ((1/0.7)^3)*tol
%%%%% accepted step 		   

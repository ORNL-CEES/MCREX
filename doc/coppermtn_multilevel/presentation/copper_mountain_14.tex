...
\begin{frame}{Evolution of a Solution: Direct Method}
  ...
  \begin{figure}[h!]
    ...
    \end{center}
    \caption{
      \only<1>{\textbf{Direct solution to Poisson Equation.}
        \textit{\sn{1}{0} total histories.} }
      \only<2>{\textbf{Direct solution to Poisson Equation.}
        \textit{\sn{1}{1} total histories.} }
      \only<3>{\textbf{Direct solution to Poisson Equation.}
        \textit{\sn{1}{2} total histories.} }
      \only<4>{\textbf{Direct solution to Poisson Equation.}

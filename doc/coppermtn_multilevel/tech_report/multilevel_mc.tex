...
$\ve{R}_l^{l+1}$, which maps a vector defined on grid $l$ to a
...
\begin{table}[h!]
  ...
  \end{center}
  \caption{\textbf{Multilevel Monte Carlo results for $k = 10$ with $M
      = 4$, $N = 10,000$ and run times reported in seconds.}}
...
\begin{table}[h!]
  ...
  \end{center}
  \caption{\textbf{Multilevel Monte Carlo results for $k = 10$ with $M
      = 4$, $N = 100,000$ and run times reported in seconds.}}
...
\begin{table}[h!]
  ...
  \end{center}
  \caption{\textbf{Multilevel Monte Carlo results for $k = 10$ with $M
      = 4$, $N = 1,000,000$ and run times reported in seconds.}}

...
\begin{frame}{Monte Carlo Communication Parameters}
  ...
  \begin{table}[htb!]
    \begin{center}
      ...
      \begin{tabular}{rl|rrrr}
        ...
        \multicolumn{1}{r}{\textbf{1024}}
        \\ \midrule
        \multirow{7}{*}{{Mesage Buffer Size}}
        %%
        & \textbf{256}	& 1.054	& 1.061	& 1.076	& 1.076 \\
        & \textbf{512}	& 1.103	& 1.146	& 1.211	& \framebox[1.1\width]{1.270} \\
        & \textbf{1024}	& 1.062	& 1.088	& 1.133	& 1.176 \\
        & \textbf{2048}	& 1.030	& 1.042	& 1.072	& 1.107 \\
        & \textbf{4096}	& 1.010	& 1.012	& 1.025	& 1.050 \\
        & \textbf{8192}	& 1.001	& \framebox[1.1\width]{1.000}	& 1.008	& 1.018 \\
        & \textbf{16384}	& 1.017	& 1.003	& 1.010	& 1.009 \\
        %%
        \bottomrule
      \end{tabular}
    \end{center}
  ...
  \item Buffer size dominates the trend
...
%%---------------------------------------------------------------------------%%
\begin{frame}{Monte Carlo Replication Scaling}
...
\begin{frame}{Stochastic Approximate Inverse Algorithm}
  ...
  \begin{itemize}
    ...
    \item A better approximation to the inverse requires more setup time and
      more storage
    \item Will investigate a drop tolerance strategy
  \end{itemize}
  ...
  \begin{table}[htb!]
    ...
    \begin{center}
      \begin{tabular}{ccccccc}
        ...
        \multicolumn{1}{c}{$N_S$} &
        \multicolumn{1}{c}{$NNZ$} &
        \multicolumn{1}{c}{$NNZ$ Ratio} &
        \multicolumn{1}{c}{MC Time (s)} &
        \multicolumn{1}{c}{Setup Time (s)} &
        \multicolumn{1}{c}{MCSA Iters}
        \\ \midrule
        %%
...
\begin{frame}{Conclusions}
  \begin{itemize}
  \item Vectorization an area of active research with a focus on heterogenous

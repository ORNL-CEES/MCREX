...
\begin{frame}{Outline}
  ...
  \item Algorithm Variations
    \vfill
  \item Current/Future Work and Conclusions
  \end{itemize}
...
\begin{frame}{Unpreconditioned Algorithm Comparison}
  ...
  \item GMRES easier to precondition - performance here only indicates Monte
    Carlo potential
...
\begin{frame}
  ...
  \center Current/Future Work and Conclusions

  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      ...
      \item Domain decomposition determined by the input system
        \bigskip
      \item Load balancing straightforward for the forward method
      \end{itemize}
    \end{column}
...
\begin{frame}{Replication}
  ...
  Different batches of Monte Carlo samplescan be combined in summation via

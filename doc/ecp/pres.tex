...
\begin{frame}{Remaining Research}
...
\begin{frame}{ECP Coordinated Reasearch}
  ...
  \item particle accelerators and neutron scattering
...
\begin{frame}{Continued Research for MC Linear Solvers}
...
\begin{frame}{Building on ASCR Funding}
  ...
  MCREX has leveraged and built on work derived from several ASCR projects:
  \begin{itemize}
  \item Trilinos
  \item XPress
  \item xSim

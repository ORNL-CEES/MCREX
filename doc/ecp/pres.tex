...
\logo{\includegraphics[width=2cm]{faded_logo}}
...
\begin{frame}{Solving the Heat Equation}
  ...
  \begin{figure}[h!]
    ...
    \end{center}
    \caption{
      \only<1>{\textit{\sn{1}{0} total histories.} }%
      \only<2>{\textit{\sn{1}{1} total histories.} }%
      \only<3>{\textit{\sn{1}{2} total histories.} }%
      \only<4>{\textit{\sn{1}{3} total histories.} }%
      \only<5>{\textit{\sn{1}{4} total histories.} }%
      \only<6>{\textit{\sn{1}{5} total histories.} }%
      \only<7>{\textit{\sn{1}{6} total histories.} }%
      \only<8>{\textit{\sn{1}{7} total histories.} }%
    }
  \end{figure}
\end{frame}
